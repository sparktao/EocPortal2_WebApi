...
namespace Hexagon.Data.DataAccess
{
    ...
    public class Database : IDatabase
    {
        ...
        /// <returns></returns>
        public int ExecuteBySql(string strSql, DbTransaction isOpenTrans)
        {
        ...
        /// <returns></returns>
        public int ExecuteBySql(string strSql, DbParameter[] parameters)
        {
        ...
        /// <param name="isOpenTrans">事务对象</param>
        /// <returns></returns>
        public int ExecuteBySql(string strSql, DbParameter[] parameters, DbTransaction isOpenTrans)
        {
        ...
        public int Update<T>(T entity)
        {
            ...
            DbParameter[] parameter = DatabaseCommon.GetParameter<T>(entity);
            val = DbHelper.ExecuteNonQuery(CommandType.Text, strSql.ToString(), ReGenerateDbParameterArray(parameter));
            return Convert.ToInt32(val);
        }
        /// <summary>
        /// 修改数据
        ...
        public int Update<T>(T entity, DbTransaction isOpenTrans)
        {
            ...
            StringBuilder strSql = DatabaseCommon.UpdateSql<T>(entity);
            DbParameter[] parameter = DatabaseCommon.GetParameter<T>(entity);
            val = DbHelper.ExecuteNonQuery(isOpenTrans, CommandType.Text, strSql.ToString(), ReGenerateDbParameterArray(parameter));
            return Convert.ToInt32(val);
        }
        ...
        public List<T> FindListPageBySql<T>(string strSql, DbParameter[] parameters, string orderby, int pageIndex, int pageSize, ref int recordCount)
        {
            return SqlServerHelper.GetPageList<T>(strSql, parameters, orderby, pageIndex, pageSize, ref recordCount);
        }
        #endregion
