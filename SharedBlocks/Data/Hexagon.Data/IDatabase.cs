...
namespace Hexagon.Data
{
    ...
    public interface IDatabase : IDisposable
    {
        ...
        int ExecuteBySql(string strSql, DbTransaction isOpenTrans);
        int ExecuteBySql(string strSql, DbParameter[] parameters);
        int ExecuteBySql(string strSql, DbParameter[] parameters, DbTransaction isOpenTrans);
        ...
        List<T> FindListPageBySql<T>(string strSql, DbParameter[] parameters, string orderby, int pageIndex, int pageSize, ref int recordCount);
